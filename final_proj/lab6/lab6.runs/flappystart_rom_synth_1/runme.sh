...
HD_PWD='C:/Users/austi/OneDrive/Desktop/385Labs/final_proj/lab6/lab6.runs/flappystart_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flappystart_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flappystart_rom.tcl
